...
DECLARE @TableName nvarchar(100) = 'Dim_Promotion';
...
TRUNCATE TABLE Staging_Promotion
...
INSERT INTO [dbo].[Staging_Promotion]
	EXEC [Sales_WH].[dbo].[Load_StagingPromotion] @Prev_LastLoadedDate, @LastLoadedDate

SELECT * FROM Staging_Promotion

EXEC [dbo].[Load_DimPromotion]
