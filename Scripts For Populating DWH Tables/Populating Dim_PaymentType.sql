...
DECLARE @TableName nvarchar(100) = 'Dim_PaymentType';
...
TRUNCATE TABLE Staging_PaymentType
...
INSERT INTO [dbo].[Staging_PaymentType]
	EXEC [Sales_WH].[dbo].[Load_StagingPaymentType] @Prev_LastLoadedDate, @LastLoadedDate

SELECT * FROM Staging_PaymentType

EXEC [dbo].[Load_DimPaymentType]

SELECT * FROM Dim_PaymentType
